...
const BlogPage = () => {
    ...
    let { title, content, banner, author: { personal_info: {
        fullname, username: author_username, profile_img } }, publishedAt } = blog;
                        ...
                        <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
                            ...
                            <div className="mt-12">
                                ...
                                <div className="flex max-sm:flex-col justify-between my-8">
                                    ...
                                    <p className="text-dark-grey opacity-75 max-sm:mt-6 max-sm:ml-12 max-sm:pl-5">
                                        Publicado el {getDay(publishedAt)}
                                    </p>
...

                            {
                                similarBlogs != null && similarBlogs.length ?
                                    <>
                                        <h1 className="text-2xl mt-14 mb-10 font-medium">Blogs Similares</h1>
