...
const ManageBlogs = () => {
    ...
    return (
        <>
            <h1 className="max_md:hidden">Administrador de Blogs</h1>
            <Toaster />
            ...
            <InPageNavigation routes={["Blogs publicados", "Borradores"]} defaultActiveIndex={activeTab != 'draft' ?
                0 : 1
            }>
                            ...
                            <>
                                ...
                                <LoadMoreDataBtn state={blogs} fetchDataFun={getBlogs}
                                    additionalParam={{
                                        ...
                                        page: blogs.page + 1 // Incrementa la página al cargar más
                                    }} />
                            </>
                            ...
                            <>
                                {
                                    drafts.results.map((blog, i) => {
                                        return <AnimationWrapper key={i} transition={{ delay: i * 0.04 }}>
                                            <ManageDraftBlogsPost blog={{ ...blog, index: i, setStateFunc: setDrafts }} />
                                        </AnimationWrapper>
                                    })
                                }
                                <LoadMoreDataBtn
                                    ...
                                    additionalParam={{
                                        ...
                                        page: drafts.page + 1 // Incrementa la página al cargar más
                                    }}
                                />
                            </>

                            : <NoDataMessage message={"No hay borradores publicados"} />
                }
